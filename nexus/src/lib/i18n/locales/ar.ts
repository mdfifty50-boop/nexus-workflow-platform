...
const ar: TranslationResource = {
  ...
  // Error messages
  errors: {
    general: 'في مشكلة بسيطة. حاول مرة ثانية.',
    unexpected: 'صار شي غير متوقع.',
    network: 'في مشكلة بالاتصال. تأكد إنك متصل بالنت.',
    networkOffline: 'ما في اتصال بالنت.',
    unauthorized: 'ما عندك صلاحية لهذا الإجراء.',
    forbidden: 'ما عندك صلاحية للوصول لهذا المحتوى.',
    notFound: 'ما لقينا اللي تدور عليه.',
    pageNotFound: 'الصفحة مو موجودة.',
    validation: 'تأكد من المعلومات وحاول مرة ثانية.',
    timeout: 'الطلب أخذ وقت طويل. حاول مرة ثانية.',
    serverError: 'في مشكلة بالسيرفر. حاول بعد شوي.',
    serviceUnavailable: 'الخدمة مو متاحة حالياً.',
    maintenance: 'النظام بصيانة. حاول بعد شوي.',
    ...
    // AI/Chat-specific errors
    aiNetworkError: 'حدث خطأ في الاتصال. دعني أحاول بطريقة أبسط - ماذا تريد أتمتته اليوم؟',
    aiTimeout: 'استغرق الطلب وقتاً طويلاً. يرجى إعادة صياغة طلبك بشكل أقصر وأكثر تحديداً.',
    aiUnavailable: 'عذراً، لم أتمكن من معالجة طلبك الآن. حاول مرة أخرى.',
    workflowGenerationFailed: 'واجهت مشكلة في إنشاء سير العمل. دعني أحاول بطريقة مختلفة.\n\nهل يمكنك وصف ما تريد أتمتته بمزيد من التفصيل؟',
    workflowNotFound: 'لم يتم العثور على سير العمل. جرب إنشاء واحد جديد.',
    noActiveWorkflow: 'لا يوجد سير عمل نشط للتعديل. يرجى إنشاء سير عمل أولاً.',
    aiEngineFailed: 'أواجه مشكلة في الاتصال بمحرك الذكاء الاصطناعي. دعني أساعدك بطريقة أخرى!',
    noEmailFound: 'لم أتمكن من العثور على بريدك الإلكتروني. يرجى إدخال بريدك الإلكتروني يدوياً.',
    rateLimited: 'تم تجاوز الحد الأقصى للطلبات. انتظر قليلاً وحاول مجدداً.',
    authExpired: 'انتهت صلاحية الاتصال. يرجى إعادة الربط.',
    missingParams: 'أحتاج معلومات إضافية لإكمال هذا الإجراء.',
    workflowGenerationFallback: 'أفهم أنك تريد: *{{understanding}}*\n\nيمكنني مساعدتك في إعداد هذا! ما التطبيقات أو الأدوات التي تريد استخدامها؟',
