...
class OAuthProxyServiceClass {
    ...
    defaultCallbackUrl = '/api/oauth/callback';
    /**
     ...
     */
    generateAuthUrl(toolkit, userId, sessionId, baseUrl, customCallbackUrl) {
     ...
     */
    generateComposioProxyUrl(toolkit, userId, sessionId, baseUrl) {
     ...
     */
    async handleComposioCallback(toolkit, code, userId, sessionId) {
     ...
     */
    async storeTokensInComposio(toolkit, userId, tokens) {
...
//# sourceMappingURL=OAuthProxyService.js.map