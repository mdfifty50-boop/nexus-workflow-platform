...
class ElevenLabsVoiceServiceClass {
     ...
     */
    buildVoiceCallConfig(preferences, workflowConfig, context) {
     ...
     */
    async getSignedCallUrl() {
        const apiKey = process.env.ELEVENLABS_API_KEY;
        if (!apiKey) {
            return { error: 'ElevenLabs API key not configured' };
        }
        try {
            const response = await fetch(`https://api.elevenlabs.io/v1/convai/conversation/get_signed_url?agent_id=${this.agentId}`, {
                method: 'GET',
                headers: {
                    'xi-api-key': apiKey,
                },
...
//# sourceMappingURL=ElevenLabsVoiceService.js.map