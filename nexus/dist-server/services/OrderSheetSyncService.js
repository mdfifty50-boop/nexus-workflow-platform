...
class OrderSheetSyncServiceClass {
    ...
    async ensureHeaders(spreadsheetId, sheetName) {
        if (this.initializedSheets.has(spreadsheetId))
            return;
        try {
     ...
     */
    async syncOrderToSheet(order, businessId) {
     ...
     */
    async updateOrderStatusInSheet(orderId, newStatus, businessId) {
        const spreadsheetId = this.getSpreadsheetId(businessId);
        if (!spreadsheetId) {
            return {
                success: false,
     ...
     */
    async findOrderRow(orderId, spreadsheetId, sheetName) {
        try {
...
//# sourceMappingURL=OrderSheetSyncService.js.map