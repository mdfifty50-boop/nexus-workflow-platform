...
class PromptGuardService {
     ...
     */
    addSecurityBoundary(systemPrompt, userInput) {
        return [
     ...
     */
    validateToolExecution(toolSlug, args, userId) {
     ...
     */
    checkArgsForInjection(args, depth = 0) {
...
// =============================================================================
function isInsideCodeBlock(text, pattern) {
...
//# sourceMappingURL=PromptGuardService.js.map