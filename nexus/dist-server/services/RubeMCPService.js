...
export const RUBE_AVAILABLE_APPS = [
    // Communication
...
class RubeMCPServiceClass {
     ...
     */
    async manageConnections(request, sessionId) {
        try {
     ...
     */
    async initiateConnections(apps, sessionId) {
     ...
     */
    async executeMultipleTools(request, sessionId) {
        const startTime = Date.now();
        try {
     ...
     */
    generateDemoToolSearch(useCase) {
     ...
     */
    generateDemoToolResponse(toolName, params) {
     ...
     */
    async sendEmail(params, sessionId) {
     ...
     */
    async createCalendarEvent(params, sessionId) {
     ...
     */
    async sendSlackMessage(params, sessionId) {
     ...
     */
    async appendToSheet(params, sessionId) {
     ...
     */
    async createGitHubIssue(params, sessionId) {
...
//# sourceMappingURL=RubeMCPService.js.map