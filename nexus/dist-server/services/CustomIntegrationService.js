...
class CustomIntegrationService {
    ...
    getAppsByCategory(category) {
        return Object.values(KNOWN_APP_APIS).filter((app) => app.category.toLowerCase() === category.toLowerCase());
    }
    /**
     * Validate API key format (doesn't test connection)
     */
    validateKeyFormat(appName, apiKey) {
     ...
     */
    async testConnection(appName, apiKey, additionalConfig) {
        const appInfo = this.getAppAPIInfo(appName);
        if (!appInfo) {
            return {
                valid: false,
     ...
     */
    saveCredentials(userId, appName, apiKey, additionalConfig) {
     ...
     */
    hasCredentials(userId, appName) {
        return this.getCredentials(userId, appName) !== null;
    }
    /**
     * Delete stored credentials
     */
    deleteCredentials(userId, appName) {
        const key = `${userId}:${appName}`;
     ...
     */
    async executeRequest(userId, appName, method, endpoint, body) {
...
//# sourceMappingURL=CustomIntegrationService.js.map