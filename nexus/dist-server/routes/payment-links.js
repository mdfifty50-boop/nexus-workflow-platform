...
router.post('/generate', async (req, res) => {
    try {
        const { amount, currency, description, customerPhone, customerEmail, orderId, callbackUrl, expiresInHours, language, provider, } = req.body;
        ...
        const validCurrencies = ['KWD', 'USD', 'SAR', 'AED', 'BHD'];
