 ...
 */
router.get('/apps/:category', (req, res) => {
 ...
 */
router.get('/info/:appName', (req, res) => {
        ...
        return res.status(404).json({
            ...
            suggestions: {
                ...
                alternatives: customIntegrationService
                    .getAppsByCategory(req.query.category || 'ACCOUNTING')
                    .slice(0, 5)
                    .map((a) => a.displayName),
            },
        });
...
//# sourceMappingURL=customIntegrations.js.map