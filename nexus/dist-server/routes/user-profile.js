...
function businessProfileDbToApi(row) {
    return {
...
function businessProfileApiToDb(profile) {
    const result = {};
    ...
    if (profile.companySize !== undefined)
        result.company_size = profile.companySize;
    if (profile.primaryRole !== undefined)
        result.primary_role = profile.primaryRole;
    if (profile.timezone !== undefined)
        result.timezone = profile.timezone;
    if (profile.automationPriorities !== undefined)
        result.automation_priorities = profile.automationPriorities;
    if (profile.painPoints !== undefined)
        result.pain_points = profile.painPoints;
    if (profile.ecommerceFields !== undefined)
        result.ecommerce_fields = profile.ecommerceFields;
    if (profile.saasFields !== undefined)
        result.saas_fields = profile.saasFields;
    if (profile.agencyFields !== undefined)
        result.agency_fields = profile.agencyFields;
    if (profile.customIndustryDescription !== undefined)
        result.custom_industry_description = profile.customIndustryDescription;
    if (profile.timeSavingsGoal !== undefined)
        result.time_savings_goal = profile.timeSavingsGoal;
    if (profile.budgetRange !== undefined)
        result.budget_range = profile.budgetRange;
    return result;
}
// ============================================================================
...
router.get('/business', async (req, res) => {
    ...
    try {
        ...
        res.json({
            profile: businessProfileDbToApi(data),
            source: 'supabase',
