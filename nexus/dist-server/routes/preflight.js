...
import { preFlightValidationService } from '../services/PreFlightValidationService';
const router = Router();
/**
...
router.post('/check', async (req, res) => {
    try {
        ...
        const result = await preFlightValidationService.check(nodes, collectedParams, connectedIntegrations);
 ...
 */
router.get('/schema/:toolSlug', async (req, res) => {
    try {
