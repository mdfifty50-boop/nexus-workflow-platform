...
function dbToApi(row) {
    return {
        ...
        accentColor: row.accent_color || 'nexus',
        ...
        workflowDefaults: row.workflow_defaults ||
            DEFAULT_PREFERENCES.workflowDefaults,
        voicePreferences: row.voice_preferences ||
 ...
 */
function apiToDb(prefs) {
    const result = {};
    if (prefs.theme !== undefined)
        result.theme = prefs.theme;
    if (prefs.accentColor !== undefined)
        result.accent_color = prefs.accentColor;
    if (prefs.language !== undefined)
        result.language = prefs.language;
    if (prefs.timezone !== undefined)
        result.timezone = prefs.timezone;
    if (prefs.emailNotifications !== undefined)
        result.email_notifications = prefs.emailNotifications;
    if (prefs.pushNotifications !== undefined)
        result.push_notifications = prefs.pushNotifications;
    if (prefs.weeklyDigest !== undefined)
        result.weekly_digest = prefs.weeklyDigest;
    if (prefs.workflowAlerts !== undefined)
        result.workflow_alerts = prefs.workflowAlerts;
    if (prefs.analyticsEnabled !== undefined)
        result.analytics_enabled = prefs.analyticsEnabled;
    if (prefs.shareUsageData !== undefined)
        result.share_usage_data = prefs.shareUsageData;
    if (prefs.workflowDefaults !== undefined)
        result.workflow_defaults = prefs.workflowDefaults;
    if (prefs.voicePreferences !== undefined)
        result.voice_preferences = prefs.voicePreferences;
    if (prefs.accessibility !== undefined)
        result.accessibility = prefs.accessibility;
    if (prefs.customSettings !== undefined)
        result.custom_settings = prefs.customSettings;
    return result;
}
// ============================================================================
// Routes
