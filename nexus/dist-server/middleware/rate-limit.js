...
export const executionLimiter = rateLimit({
    ...
    handler: make429Handler('Too many execution requests. Please wait before running more workflows.', 'Workflow execution is resource-intensive. Wait a moment and try again.'),
    skip: shouldSkip
});
/**
...
export const discoveryLimiter = rateLimit({
    ...
    validate: { keyGeneratorIpFallback: false },
    keyGenerator: getUserKey,
    handler: make429Handler('Too many discovery requests. Please slow down.', 'Wait a moment before searching for more tools.'),
    skip: shouldSkip
});
/**
...
export const connectionLimiter = rateLimit({
    ...
    validate: { keyGeneratorIpFallback: false },
    keyGenerator: getUserKey,
    handler: make429Handler('Too many connection requests. Please wait before managing more connections.', 'OAuth flows are rate-limited for security. Wait a moment and try again.'),
    skip: shouldSkip
});
/**
...
export const generalApiLimiter = rateLimit({
    ...
    validate: { keyGeneratorIpFallback: false },
    keyGenerator: getUserKey,
    handler: make429Handler('Too many requests. Please slow down.', 'Wait a moment before making more requests.'),
    skip: shouldSkip
});
