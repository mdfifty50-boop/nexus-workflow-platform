...
import { workflowOrchestrator, type WorkflowDefinition } from '../services/WorkflowOrchestrator.js'
 ...
 */
router.get('/oauth/authorize/:providerId', extractClerkUserId, (req: Request, res: Response) => {
  ...
  const result = integrationService.generateAuthUrl(
    providerId,
    clerkUserId,
    projectId as string,
 ...
 */
router.post('/oauth/reconnect/:credentialId', extractClerkUserId, async (req: Request, res: Response) => {
 ...
 */
router.delete('/:projectId/:providerId', extractClerkUserId, async (req: Request, res: Response) => {
 ...
 */
router.post('/health/:credentialId', async (req: Request, res: Response) => {
  const { credentialId } = req.params
 ...
 */
router.get('/analytics/:projectId', extractClerkUserId, async (req: Request, res: Response) => {
  const { projectId } = req.params
  const clerkUserId = req.body.clerk_user_id
...
router.post('/hubspot', async (req, res) => {
  try {
    ...
    async function hubspotRequest(method: string, endpoint: string, body?: any): Promise<any> {
 ...
 */
function getRubeToolSlug(integration: string, action: string): string | null {
  ...
  if (!integrationTools) return null
 ...
 */
router.post('/execute', extractClerkUserId, async (req: Request, res: Response) => {
  ...
  try {
    ...
    let provider: 'rube' | 'playwright' | 'embedded' = 'rube'
 ...
 */
router.post('/workflow/execute', extractClerkUserId, async (req: Request, res: Response) => {
 ...
 */
router.post('/test', extractClerkUserId, async (req: Request, res: Response) => {
 ...
 */
router.get('/workflow/:workflowId/status', (_req: Request, res: Response) => {
