 ...
 */
router.get('/connection/:toolkit', async (req: Request, res: Response) => {
 ...
 */
router.post('/execute-with-account', async (req: Request, res: Response) => {
 ...
 */
router.get('/debug/all-connections', async (_req: Request, res: Response) => {
  try {
    await ensureInitialized()
 ...
 */
router.get('/debug/connect-gmail', async (_req: Request, res: Response) => {
  try {
    await ensureInitialized()
 ...
 */
router.get('/debug/list-auth-configs', async (_req: Request, res: Response) => {
  try {
    await ensureInitialized()
 ...
 */
router.get('/gmail/fetch', async (req: Request, res: Response) => {
 ...
 */
router.post('/calendar/create', async (req: Request, res: Response) => {
 ...
 */
router.post('/sheets/read', async (req: Request, res: Response) => {
 ...
 */
router.post('/sheets/append', async (req: Request, res: Response) => {
 ...
 */
router.get('/user/:userId/apps', async (req: Request, res: Response) => {
 ...
 */
router.post('/user/:userId/connect/:appId', async (req: Request, res: Response) => {
 ...
 */
router.delete('/user/:userId/disconnect/:appId', async (req: Request, res: Response) => {
  const { userId, appId } = req.params
 ...
 */
router.post('/user/:userId/execute', async (req: Request, res: Response) => {
  const { userId } = req.params
  const { toolSlug, params } = req.body
...
const localWorkflowStore: Map<string, {
  id: string
  name: string
  description?: string
...
async function fetchComposioRecipes(apiKey: string): Promise<any[]> {
  try {
...
router.get('/recipes', async (req: Request, res: Response) => {
  ...
  try {
    ...
    const formattedRecipes = composioRecipes.map((recipe: any) => ({
 ...
 */
router.post('/recipes/:recipeId/schedule', async (req: Request, res: Response) => {
  const { recipeId } = req.params
  ...
  try {
    ...
    if (localWorkflowStore.has(recipeId)) {
      ...
      if (action === 'pause' && workflow.schedule) {
        ...
        if (cron) workflow.schedule.cron = cron
        if (cron) workflow.schedule.cronHuman = parseCronToHuman(cron)
      }
 ...
 */
router.delete('/recipes/:recipeId/schedule', async (req: Request, res: Response) => {
  const { recipeId } = req.params
  const apiKey = process.env.COMPOSIO_API_KEY
 ...
 */
router.post('/workflows/track', async (req: Request, res: Response) => {
