 ...
 */
router.get('/workflow/:workflowId/unresolved', async (req: Request, res: Response) => {
  const { workflowId } = req.params
...
router.get('/stats', async (req: Request, res: Response) => {
  ...
  const stats = await errorRecoveryService.getErrorStats(workflow_id as string | undefined)
 ...
 */
router.post('/:errorId/skip', async (req: Request, res: Response) => {
 ...
 */
router.post('/:errorId/resolve', async (req: Request, res: Response) => {
  const { errorId } = req.params
 ...
 */
router.post('/:errorId/apply-fix', async (req: Request, res: Response) => {
  const { errorId } = req.params
