...
import { mcpProviderService, MCPProviderType } from '../services/MCPProviderService.js'
 ...
 */
router.post('/connect/:provider/:toolkit', async (req: Request, res: Response) => {
  ...
  try {
    ...
    const result = await mcpProviderService.initiateConnection(
      provider as MCPProviderType,
      toolkit,
      redirectUrl
    )
...
router.get('/callback/:provider', async (req: Request, res: Response) => {
  ...
  try {
    ...
    const result = await mcpProviderService.handleOAuthCallback(
      provider as MCPProviderType,
      String(code),
...
router.post('/execute', async (req: Request, res: Response) => {
  ...
  try {
    ...
    const result = await mcpProviderService.executeTool(
      toolSlug,
      params || {},
      preferredProvider as MCPProviderType | undefined
    )
 ...
 */
router.post('/execute/:provider', async (req: Request, res: Response) => {
  const { provider } = req.params
 ...
 */
router.get('/zapier/status', async (_req: Request, res: Response) => {
  try {
    await ensureInitialized()
 ...
 */
router.get('/google/tools', async (_req: Request, res: Response) => {
  res.json({
    success: true,
    provider: 'google',
    tools: [
 ...
 */
router.get('/zapier/tools', async (_req: Request, res: Response) => {
  res.json({
    success: true,
    provider: 'zapier',
    tools: [
