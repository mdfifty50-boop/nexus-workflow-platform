 ...
 */
router.get('/archived', extractClerkUserId, async (req: Request, res: Response) => {
  try {
    const clerkUserId = req.body.clerk_user_id
 ...
 */
router.post('/:id/restore', extractClerkUserId, async (req: Request, res: Response) => {
  try {
    const clerkUserId = req.body.clerk_user_id
 ...
 */
router.get('/:id/analytics', extractClerkUserId, async (req: Request, res: Response) => {
  try {
    const clerkUserId = req.body.clerk_user_id
 ...
 */
router.get('/:id/members', extractClerkUserId, async (req: Request, res: Response) => {
  try {
    const clerkUserId = req.body.clerk_user_id
 ...
 */
router.post('/:id/members', extractClerkUserId, async (req: Request, res: Response) => {
  try {
 ...
 */
router.put('/:id/members/:memberId', extractClerkUserId, async (req: Request, res: Response) => {
  try {
 ...
 */
router.delete('/:id/members/:memberId', extractClerkUserId, async (req: Request, res: Response) => {
  try {
    const clerkUserId = req.body.clerk_user_id
 ...
 */
router.post('/:id/leave', extractClerkUserId, async (req: Request, res: Response) => {
  try {
    const clerkUserId = req.body.clerk_user_id
