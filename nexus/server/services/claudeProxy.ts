...
export function classifyTask(systemPrompt: string, userMessage: string): TaskType {
  ...
  let maxScore = 0
  let bestTask: TaskType = 'content_generation' // Default to Sonnet-level
 ...
 */
export function getModelForTask(taskType: TaskType): { model: string; tier: ModelTier } {
 ...
 */
export function calculateModelCost(tier: ModelTier, inputTokens: number, outputTokens: number): number {
...
export const tieredCalls = {
   ...
   */
  classify: (systemPrompt: string, userMessage: string, maxTokens = 500) =>
   ...
   */
  extract: (systemPrompt: string, userMessage: string, maxTokens = 1000) =>
    callClaudeWithTiering({
      systemPrompt,
      userMessage,
      maxTokens,
   ...
   */
  statusUpdate: (systemPrompt: string, userMessage: string, maxTokens = 500) =>
    callClaudeWithTiering({
      systemPrompt,
      userMessage,
      maxTokens,
   ...
   */
  planWorkflow: (systemPrompt: string, userMessage: string, maxTokens = 4096) =>
    callClaudeWithTiering({
      systemPrompt,
      userMessage,
      maxTokens,
   ...
   */
  generateCode: (systemPrompt: string, userMessage: string, maxTokens = 4096) =>
    callClaudeWithTiering({
      systemPrompt,
      userMessage,
      maxTokens,
   ...
   */
  generateContent: (systemPrompt: string, userMessage: string, maxTokens = 4096) =>
    callClaudeWithTiering({
      systemPrompt,
      userMessage,
      maxTokens,
   ...
   */
  complexReasoning: (systemPrompt: string, userMessage: string, maxTokens = 8192) =>
    callClaudeWithTiering({
      systemPrompt,
      userMessage,
      maxTokens,
   ...
   */
  criticalDecision: (systemPrompt: string, userMessage: string, maxTokens = 8192) =>
    callClaudeWithTiering({
      systemPrompt,
      userMessage,
      maxTokens,
...
// =============================================================================
// TIERING METRICS TRACKING
// =============================================================================

interface TieringMetrics {
  totalCalls: number
 ...
 */
export function recordTieringMetrics(tier: ModelTier, taskType: TaskType, costUSD: number, savingsUSD: number): void {
  metrics.totalCalls++
 ...
 */
export function getTieringMetrics(): TieringMetrics & {
  avgCostPerCall: number
  savingsPercentage: number
  tierDistribution: Record<ModelTier, string>
} {
  ...
  const tierDistribution: Record<ModelTier, string> = {
 ...
 */
export function resetTieringMetrics(): void {
