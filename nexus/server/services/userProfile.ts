...
export const userProfileService = {
   ...
   */
  async createProfile(data: CreateProfileData): Promise<UserProfile | null> {
    if (!supabase) {
   ...
   * Update user profile
   */
  async updateProfile(clerkUserId: string, data: UpdateProfileData): Promise<UserProfile | null> {
    if (!supabase) {
      console.error('Supabase not configured')
      return null
    }
   ...
   */
  async deleteProfile(clerkUserId: string): Promise<boolean> {
    if (!supabase) {
      console.error('Supabase not configured')
      return false
    }
   ...
   */
  async updateEmotionalResponses(
    clerkUserId: string,
   ...
   */
  async deletePersonalizationData(clerkUserId: string): Promise<UserProfile | null> {
