...
class CatalogueService {
  ...
  private products: Map<string, CatalogueProduct> = new Map()
   ...
   */
  createProduct(input: CreateProductInput): CatalogueProduct {
   ...
   */
  getProduct(id: string): CatalogueProduct | undefined {
   ...
   */
  updateProduct(id: string, input: UpdateProductInput): CatalogueProduct | undefined {
   ...
   */
  listProducts(filter?: CatalogueFilter): CatalogueProduct[] {
   ...
   */
  getProductsByCategory(category: string): CatalogueProduct[] {
   ...
   */
  searchForCustomer(query: string): string {
  ...
  private seedDemoData(): void {
    const demoProducts: CreateProductInput[] = [
      {
