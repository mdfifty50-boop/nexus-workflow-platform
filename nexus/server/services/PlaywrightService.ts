...
class PlaywrightServiceClass {
   ...
   * Navigate to URL
   */
  async navigate(options: NavigationOptions): Promise<BrowserTaskResult> {
   ...
   * Click element
   */
  async click(options: ClickOptions): Promise<BrowserTaskResult> {
    const startTime = Date.now()
    const result: BrowserTaskResult = {
      success: false,
      screenshots: [],
   ...
   * Type text
   */
  async type(options: TypeOptions): Promise<BrowserTaskResult> {
    const startTime = Date.now()
    const result: BrowserTaskResult = {
      success: false,
      screenshots: [],
   ...
   */
  async extract(options: ExtractOptions): Promise<BrowserTaskResult> {
    const startTime = Date.now()
    const result: BrowserTaskResult = {
      success: false,
      screenshots: [],
   ...
   * Take screenshot
   */
  async screenshot(name?: string): Promise<BrowserTaskResult> {
    const startTime = Date.now()
    const result: BrowserTaskResult = {
      success: false,
      screenshots: [],
   ...
   */
  async snapshot(): Promise<BrowserTaskResult> {
    const startTime = Date.now()
    const result: BrowserTaskResult = {
      success: false,
      screenshots: [],
   ...
   */
  async wait(options: { selector?: string; time?: number }): Promise<BrowserTaskResult> {
    const startTime = Date.now()
    const result: BrowserTaskResult = {
      success: false,
      screenshots: [],
   ...
   */
  async fillForm(fields: Array<{ selector: string; value: string; type?: string }>): Promise<BrowserTaskResult> {
    const startTime = Date.now()
    const result: BrowserTaskResult = {
      success: false,
      screenshots: [],
  ...
  async executeBookingFlow(config: {
    ...
    selectionCriteria?: { preferLowestPrice?: boolean }
