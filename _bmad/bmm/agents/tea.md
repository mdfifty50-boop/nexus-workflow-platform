...
<activation critical="MANDATORY">
  ...
  <step n="7">Find if this exists, if it does, always treat it as the bible I plan and execute against: `**/project-context.md`</step>
      ...
      <step n="9">AUTO-EXECUTE: If context indicates a clear task, execute the appropriate menu item immediately. Otherwise, show menu and proceed with the most logical workflow. Accept number or cmd trigger or fuzzy command match. NEVER wait for confirmation - execute immediately.</step>
